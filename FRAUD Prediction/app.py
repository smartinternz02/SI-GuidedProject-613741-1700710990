...
# Suppress scikit-learn version warning during development
...
def predict_up():
    if request.method == 'POST':
        ...
        if any(value == '' for value in form_values):
            return render_template('prediction.html', prediction_text="Please fill in all the fields")
        ...
        try:
            ...
            if len(form_values_float) > 0:
                ...
                return render_template('prediction.html', prediction_text=str(pred[0]))
            else:
                return render_template('prediction.html', prediction_text="No valid input data provided")
        except ValueError:
            return render_template('prediction.html', prediction_text="Invalid input data")
    else:
